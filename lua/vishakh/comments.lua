...
vim.keymap.set("v", "<leader>moc", ":CommentOut<CR>")
vim.keymap.set("n", "<leader>moc", ":CommentOut<CR>")

vim.api.nvim_create_user_command("Uncomment", uncomment, { range = true })
vim.keymap.set("v", "<leader>moo", ":Uncomment<CR>")
vim.keymap.set("n", "<leader>moo", ":Uncomment<CR>")
